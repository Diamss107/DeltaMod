...
package net.mcreator.deltamod.fluid.attributes;
...
public class AngeliFluidAttributes extends FluidAttributes {
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, AngeliFluidAttributes::new);
	}
	...
	protected AngeliFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}
